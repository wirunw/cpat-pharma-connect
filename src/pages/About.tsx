...
<section className="py-16 px-4 bg-white">
  <div className="container mx-auto max-w-6xl">
    <div className="text-center mb-12">
      <h2 className="text-3xl font-bold text-blue-900 mb-4">คณะกรรมการและผู้ร่วมก่อตั้ง</h2>
      <p className="text-xl text-blue-700 max-w-3xl mx-auto">
        รายชื่อคณะกรรมการและผู้ร่วมก่อตั้งวิทยาลัยการบริหารเภสัชกิจแห่งประเทศไทย
      </p>
    </div>

    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
      {[
        { name: "รศ.ดร.ภก. กร ศรเลิศล้ำวาณิช", role: "ผู้อำนวยการ", email: "korn.s@cpat.ac.th" },
        { name: "ภก. รุ่งเพ็ชร สกุลบำรุง", role: "ที่ปรึกษาวิทยาลัย", email: "rungpetch.c@cpat.ac.th" },
        { name: "ภญ. พนิดา ปัญญางาม", role: "เหรัญญิก", email: "panida.p@cpat.ac.th" },
        { name: "ภญ. พุศราพร เกษสมบูรณ์", role: "เลขาธิการ", email: "nusaraporn.k@cpat.ac.th" },
        { name: "ภญ. หทัยกาญจน์ เชาวน์ประดิษฐ", role: "รองผู้อำนวยการ", email: "hathaikan.c@cpat.ac.th" },
        { name: "ภก. ผดุงยศ พิสุทธานันท์", role: "รองผู้อำนวยการ", email: "padoongyost.p@cpat.ac.th" },
        { name: "ภก. อนุชัย ธีระเรื่องไพศาล", role: "รองผู้อำนวยการ", email: "anuchai.t@cpat.ac.th" },
        { name: "ภญ. กุลจิรา อุดมอักษร", role: "รองเลขาธิการ", email: "khunjira.u@cpat.ac.th" },
        { name: "ภก. โอสถ เนระพูสี", role: "รองเลขาธิการ", email: "osot.n@cpat.ac.th" },
        { name: "ภก. วิรุณ เวชศิริ", role: "นายทะเบียน", email: "wirun.w@cpat.ac.th" },
        { name: "ภญ. สุทธิพงศ์ หนูฤทธิ์", role: "ประชาสัมพันธ์", email: "sutthipong.n@cpat.ac.th" },
        // เพิ่มผู้ร่วมก่อตั้งต่อไปเรื่อย ๆ จากข้อมูลทั้งหมด
        { name: "ภก. ทวีศักดิ์ สีทองสุข", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "thaweesak01@gmail.com" },
        { name: "ภญ. จิราพร ลิ้มปานะวงศ์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "jiraporn.l@chula.ac.th" },
        { name: "ภญ. บุษกร เลิศวัฒนานันท์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "busakornlee@gmail.com" },
        { name: "ภก. ซะอรสิน สุขศรีวิบูลย์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "chaoncin.s@cpat.ac.th" },
        { name: "ภก. วิทยา กุลสมบูรณ์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "vithaya.k@chula.ac.th" },
        { name: "ภญ. ศรีเพ็ญ ต้นติเวสส์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "stantivess@gmail.com" },
        { name: "ภญ. วรรณี ชัยเฉลิมพจน์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "wannee.c@cpat.ac.th" },
        { name: "ภก. อาทร ริ้วไพบูลย์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "arthorn.rie@moph.go.th" },
        { name: "ภญ. เนตรนภิส สุชนวนิช", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "netnapis.s@hitap.net" },
        { name: "ภญ. วิมล สุวรรณเกษม", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "wimon.s@cpat.ac.th" },
        { name: "ภก. อนุวัตร เลิศพิทักษ์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "anuwat.l@cpat.ac.th" },
        { name: "ภญ. กุสาวดี เมลืองนนท์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "kusawadee.m@cpat.ac.th" },
        { name: "ภก. วีรยุทธ์ เลิศนทีวุฒิ", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "verayuth.l@cpat.ac.th" },
        { name: "ภก. สุจินต์ นิทัศน์ปกรณ์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "sujin.n@cpat.ac.th" },
        { name: "ภญ. อินทิรา กาญจนพิทักษ์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "inthira.k@cpat.ac.th" },
        { name: "ภก. ภูริทัต ว่องพุฒิพงศ์", role: "สมาชิกผู้ร่วมก่อตั้ง", email: "puritat.w@cpat.ac.th" },
        // ... เพิ่มรายชื่อจนครบตามที่วิรุณให้ไว้
      ].map((member, index) => (
        <div key={index} className={`p-6 rounded-lg shadow-md ${index % 2 === 0 ? 'bg-blue-50' : 'bg-white'}`}>
          <div className="flex items-start">
            <div className="text-2xl mr-3">👤</div>
            <div>
              <p className="text-blue-900 font-bold">{member.name}</p>
